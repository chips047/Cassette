...
def ui_sound(name, tone = None, volume = 1.0, random_spread = 0.03):
    try:
        ...
        sound = pygame.mixer.Sound(f"System/Assets/Sounds/{name}.wav")
        array = pygame.sndarray.array(sound)

        rate = np.random.uniform(1.0 - random_spread, 1.0 + random_spread)
